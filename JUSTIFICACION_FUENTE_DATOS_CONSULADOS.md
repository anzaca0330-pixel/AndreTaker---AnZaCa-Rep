...
**Perito Principal:** Andrea Zabala Cárcamo (C.C. 43.925.102)  
...
* 📊 **`ESTUDIO_ESTADISTICO_ANOMALIAS_CONSULADOS.md`** (Prueba de hipótesis Z = -56.96, p < 0.0001 y Ley de Benford).
