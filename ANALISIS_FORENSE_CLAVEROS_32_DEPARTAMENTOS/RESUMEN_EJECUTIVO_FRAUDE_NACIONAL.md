...
```mermaid
pie title Distribución Nacional vs Oficial (Votos Cepeda)
    "Registraduría (Oficial)": 12708712
    "Testigos (Preconteo)": 12708712
```

```mermaid
pie title Distribución Nacional vs Oficial (Votos Espriella)
    "Registraduría (Oficial)": 12959542
    "Testigos (Preconteo)": 12959542
```
