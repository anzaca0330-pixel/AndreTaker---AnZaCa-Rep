...
> Este hallazgo es la culminación de una cadena de descubrimientos forenses originales que siguieron un estricto orden cronológico: inició con la detección masiva de **páginas blancas** (archivos vacíos o purgados), lo que condujo al hallazgo de las anomalías de compresión estructural `FlateDecode`, derivando en la identificación del *Blind Masking* (aplanamiento de capas), y finalmente en la decodificación del QR Spoofing. 
> Si bien disciplinas como la Informática Forense de Imágenes (Blind Image Forensics) son preexistentes, el descubrimiento de su **aplicación clandestina** para perpetrar este fraude electoral masivo y la metodología para aislarlo estructuralmente en las actas E-14 constituyen el trabajo original y la Propiedad Intelectual de la investigadora bajo el modelo Open Source para uso de la CIDH.
> 
> **CLÁUSULA DE LICENCIAMIENTO Y ATRIBUCIÓN (Apache License 2.0):** De acuerdo con el modelo Open Source adoptado en este repositorio, se **permite libremente** el uso, reproducción, adaptación y distribución de este hallazgo pericial (Vector expectedName, Páginas Blancas, FlateDecode y QR Spoofing) por parte de desarrolladores, terceros, organizaciones políticas o auditores de datos. Todo uso está sujeto a la condición estricta e irrenunciable de mantener los avisos de derechos de autor y **otorgar el crédito explícito a la autora original: Andrea Zabala Carcamo**. El incumplimiento de la atribución constituye una violación directa de los términos de la Licencia Apache 2.0.
