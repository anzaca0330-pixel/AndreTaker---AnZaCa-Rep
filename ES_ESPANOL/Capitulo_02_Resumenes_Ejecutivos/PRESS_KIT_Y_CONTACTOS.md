# Kit de Prensa y Plantillas de Contacto Internacional

Este documento contiene los mensajes estandarizados listos para enviar a periodistas de investigación, organizaciones de Derechos Humanos y expertos forenses con el objetivo de lograr una rápida validación por pares (Peer Review) y escalamiento mediático del caso.

## 1. Comunicado de Prensa (Prensa de Investigación)
*Para enviar vía Twitter (X) y correo electrónico a medios como OjoPúblico, Connectas, Wired, ProPublica y a la cuenta oficial de la CIDH.*
...
> 
> 📁 **Repositorio de Evidencia y Scripts:** [Link]
> 
> Agradezco de antemano su tiempo y valiosa revisión técnica.

## 3. Mensaje para ONGs de Derechos Humanos
*Para enviar al equipo de Derechos Digitales de Human Rights Watch, Amnistía Internacional y Transparencia Electoral.*

> **Asunto:** URGENTE - Evidencia Técnica de Cooptación Democrática - Solicitud de Apoyo ante la CIDH
> 
> Estimado equipo de [Organización],
> 
> La democracia colombiana enfrenta un colapso institucional. Tras el bloqueo y censura del acceso a los datos de escrutinio, una auditoría técnica ciudadana masiva ha recolectado evidencia forense irrefutable de que la base de datos oficial electoral de 2026 ha sido alterada estructuralmente mediante la inserción de archivos sintéticos y corrupción criptográfica (borrado de metadatos de hardware).
> 
