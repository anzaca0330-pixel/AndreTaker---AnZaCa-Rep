...
## Detection of Anomalous Distributions and Algorithmic Generation in Electoral Datasets (2026 Elections)

**Course:** PSY/315 - Statistical Reasoning in Psychology  
**Author:** Andrea Zabala  
**Date:** August 2026  
**Confidentiality Level:** 🔴 HIGH / FORENSIC EVIDENCE  

<br>
<i>"Numbers dictated by human nature vary organically; numbers dictated by machines sing an exact melody."</i>
<br><br>
...
![Distribución de Segundo Dígito (Prueba 2BL - Datos Reales)](real_benford_histogram.svg)

### 4.3. Monte Carlo Simulations and P-Value Calculations
...
**🔗 Full Forensic GitHub Repository (Statistical Analysis):** [02_ANALISIS/SESION_02_ESTADISTICA_Y_BENFORD](https://github.com/anzaca0330-pixel/AndreTaker---AnZaCa-Rep/tree/main/02_ANALISIS/SESION_02_ESTADISTICA_Y_BENFORD)
**📊 Interactive Stochastic Dashboard:** [Live Gaussian Bells Dashboard](https://anzaca0330-pixel.github.io/AndreTaker---AnZaCa-Rep/02_ANALISIS/SESION_02_ESTADISTICA_Y_BENFORD/dashboard_campanas_gauss.html)
