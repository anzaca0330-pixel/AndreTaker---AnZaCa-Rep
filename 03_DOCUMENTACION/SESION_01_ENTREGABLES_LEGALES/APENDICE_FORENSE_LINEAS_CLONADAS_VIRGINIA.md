...
1.  **`(434) 466-8360`** (Línea Central / Hub de Control - Activa en Junio y Agosto)
...
### A. Intercomunicación de la Red Clónica (Hub `466-8360`)
La línea `(434) 466-8360` coordinaba y enlazaba las llamadas entre los dispositivos de la red intrusa:
*   **Tráfico con la línea `(434) 414-4130` (Agosto 2026):**
    *   **Ago 09 | 11:39 AM:** OUT `414-4130` hacia central `466-8360` (1 min).
    *   **Ago 09 | 12:15 PM:** OUT `414-4130` hacia central `466-8360` (7 min).
    *   **Ago 09 | 12:54 PM:** IN en `414-4130` desde central `466-8360` (3 min).
    *   **Ago 09 | 1:35 PM:** IN en `414-4130` desde central `466-8360` (3 min).
    *   **Ago 09 | 3:03 PM:** IN en `414-4130` desde central `466-8360` (1 min).
    *   **Ago 09 | 3:08 PM:** IN en `414-4130` desde central `466-8360` (1 min).
    *   **Ago 09 | 3:41 PM:** IN en `414-4130` desde central `466-8360` (1 min).
    *   **Ago 09 | 3:50 PM:** IN en `414-4130` desde central `466-8360` | **Duración: 15 min**.
    *   **Ago 09 | 3:58 PM:** OUT `414-4130` hacia central `466-8360` (2 min).
    *   **Ago 09 | 6:33 PM:** IN en `414-4130` desde central `466-8360` (2 min).
    *   **Ago 10 | 9:14 AM:** IN en `414-4130` desde central `466-8360` (1 min).
    *   **Ago 10 | 9:56 AM:** IN en `414-4130` desde central `466-8360` (4 min).
*   **Tráfico con la línea `(434) 391-1195` (Agosto 2026):**
    *   **Ago 09 | 6:45 PM:** IN en `391-1195` desde central `466-8360` | **Duración: 13 min**.
*   **Tráfico con la línea `(434) 581-3271` (Junio 2026):**
    *   **Jun 08 | 11:19 AM:** IN en `581-3271` desde central `466-8360` (2 min).
    *   **Jun 08 | 9:11 PM:** IN en `581-3271` desde central `466-8360` (5 min).

### B. Llamadas Intrusas al Círculo Familiar y de Datos a Colombia
La línea clónica central `(434) 466-8360` fue utilizada para contactar directamente a personas de tu entorno y realizar llamadas de larga distancia:
*   **Llamadas al entorno familiar (`(434) 242-4365`):**
    *   **Jun 17 | 4:34 PM:** IN (Entrante) desde `242-4365` hacia la línea clónica `466-8360` (2 min).
    *   **Jun 17 | 9:45 PM:** OUT (Saliente) desde la línea clónica `466-8360` hacia `242-4365` (4 min).
*   **Llamada a Colombia:**
    *   **Jun 17 | 6:22 PM:** OUT (Saliente) desde la línea clónica `466-8360` hacia el número **`+57 301 254 8502`** (Colombia) (1 min).
