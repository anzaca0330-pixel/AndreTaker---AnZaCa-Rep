# CORREO OFICIAL LISTO PARA ENVIAR A ASSURANT
## Claim Number: 00115536906 | Adjuster: Yisell

**Para:** `myclaiminfo@assurant.com`, `ClientLetter@assurant.com`  
**Asunto:** `Re: Claim Number 00115536906 - Comprehensive Loss Statement, Child Data Theft & Financial Loss Estimate (Andrea Zabala Carcamo)`  
...
- Copias o capturas de las facturas/extractos bancarios que tengas disponibles
...
Subject: Re: Claim Number 00115536906 - Comprehensive Loss Statement, Child Data Theft & Financial Loss Estimate (Andrea Zabala Carcamo)
...
Pursuant to my active policy coverage under ExpressVPN Identity Defender / Assurant ($3,000,000 USD Identity Fraud & Cybercrime Policy), I am submitting my formal Comprehensive Loss Statement, Minor Child Identity Theft Report, Bank Account Compromise Notice, and Itemized Financial Loss Estimate resulting directly from targeted identity theft, Dark Web credential breaches, persistent hardware rootkit destruction, vehicle sabotage, physical harassment, and emergency multi-country protective relocation.
...
- Severe Bank Account Compromise: Unauthorized banking intrusion attempts, account lockouts, severe credit score damage, and overdraft fee accruals caused directly by identity theft during my 3 months of enforced unemployment.
- Firmware Rootkit infection hardware-locking my primary ThinkPad workstation (Lenovo Support Key Ref: 2031621994).
- Installation of an autonomous battery-powered rogue Wi-Fi surveillance implant at my home (which remained transmitting even when the main household electrical breaker was switched off).
...
1. Formal assignment of a dedicated Assurant Identity Restoration Claims Adjuster to process this reimbursement claim.
2. Immediate specialized assistance for Minor Child Identity Restoration and Bank Account Fraud Remediation.
3. Direct assistance in initiating FCRA Credit Bureau freezes (Experian, Equifax, TransUnion) and data broker removals across tracking portals.
4. Guidance on submitting available receipts, dealership work orders, bank statements, and police incident documentation for formal processing.

Please confirm receipt of this email and advise on the next steps for claim processing.
