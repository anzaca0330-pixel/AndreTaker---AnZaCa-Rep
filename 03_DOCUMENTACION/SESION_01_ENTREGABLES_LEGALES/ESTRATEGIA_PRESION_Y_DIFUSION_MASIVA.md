...
```mermaid
graph TD
    A[ACERVO FORENSE INMUTABLE 136 GB] --> B[Frente Legal & Corte Internacional]
    A --> C[Frente Mediático & Periodismo de Investigación]
    A --> D[Frente Académico & Rigor Estadístico]
    A --> E[Frente Político & Diplomático Internacional]
    A --> F[Frente Ciudadano & Veeduría Descentralizada]
```
...
* **Acción:** No esperar respuestas pasivas del sistema local. Usar los números de caso (`Sheriff C20260617-0024-01`, `Lenovo Key Ref 2031621994`) como certificados fácticos de hostigamiento.
