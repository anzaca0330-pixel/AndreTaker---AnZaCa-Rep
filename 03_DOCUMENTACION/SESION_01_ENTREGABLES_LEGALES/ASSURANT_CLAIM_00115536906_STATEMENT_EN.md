# OFFICIAL IDENTITY THEFT & CYBERATTACK INSURANCE CLAIM STATEMENT
...
**First Notice of Loss Date:** 08-12-2026  
**Date of Formal Submission:** August 27, 2026  
**Receiving Entity:** Assurant / ExpressVPN Identity Defender Legal & Claims Department  
**Adjuster:** Yisell (FSO Claims Operations)  
**Adjuster Email:** `myclaiminfo@assurant.com` / `ClientLetter@assurant.com`  
**Toll-Free Claims Helpline:** 📞 `+1-800-358-0600 Ext. 4038684`  
**Immutable Chain of Custody:** SHA-256 Sealed Evidence on GitHub & Internet Archive (`colombia-e14-forensic-acervo-2026`)
...
## ⚡ 2. CHRONOLOGY OF QUALIFYING COVERED EVENTS

### A. Dark Web Credential Breaches & Minor Child Data Theft (June - July 2026)
* ExpressVPN Identity Defender (Restoration ID: 85720870) issued critical notifications regarding unauthorized Dark Web exposures of email addresses, passwords, and personal identifiers.
* **Child Data Theft & Compromise:** Claimant's 10-year-old child's personal identifiers, school/medical records, and mobile line were severely compromised and exposed online following the June 13 emergency dispatch call, triggering over 1,600 barrage tracking calls/messages.

### B. Severe Bank Account Compromise & Financial Distress
* Targeted unauthorized banking intrusion attempts, fraudulent account lockouts, severe credit score damage, and overdraft fee accruals caused directly by identity theft during Claimant's 3 months of enforced unemployment.

### C. Firmware Rootkit Infection & Lenovo Hardware Lockout (June 8, 2026)
* Claimant's primary ThinkPad work machine suffered an advanced firmware-level Rootkit attack, hardware-locking the BIOS.
* **Official Support Ticket:** Lenovo Support Key Ref `2031621994`.

### D. Autonomous Phantom Wi-Fi Network & Physical Surveillance Implant
* A certified cable technician and Claimant's spouse verified the continuous transmission of an anomalous rogue Wi-Fi signal anchored to the ExpressVPN Aircove router spectrum.
* **Main Circuit Breaker Test:** When total household electrical power was disconnected (leaving the residence in complete darkness), **the phantom Wi-Fi network remained actively transmitting**, confirming the physical implantation of an autonomous battery-powered surveillance device on the property.

### E. Vehicle Sabotage, OBD-II Vector (FIXD) & Ambush (June 13 & 20, 2026)
...
### F. FBI Submission, IACHR Filing, Mexico Refuge & Canada Relocation
...
---
*Signed and submitted by Andrea Zabala Cárcamo (Claim Number: 00115536906 / Restoration ID: 85720870).*
