...
*   **Annex 7 (Statistical Analysis):** The original spreadsheet and Python scripts used to calculate the 2.5 standard deviation and Benford's Law (2nd Digit - Mebane) visualizations.
