...
```mermaid
graph TD
    A["👑 INICIO DE INVESTIGACIÓN FORENSE (31 Mayo - 01 Junio 2026)"] --> B["Fase 1: Anomalía de Los Ángeles & Benford 2BL"]
    B --> C1["🔬 Rama Técnica: MAPEO_INYECCION_LOS_ANGELES_1RA_VUELTA.md"]
    B --> C2["⚖️ Rama Legal: ESTUDIO_ESTADISTICO_ANOMALIAS_CONSULADOS.md"]
    B --> C3["🗣️ Rama Ciudadana: Resumen Votos Clónicos =REDONDEAR"]

    A --> D["Fase 2: Asedio, Bloqueo de Red & Rescate SHA-256 (08 - 21 Junio)"]
    D --> E1["🔬 Rama Técnica: REPORTE_FORENSE_BLOQUEO_ACCESO_DATOS.md"]
    D --> E2["⚖️ Rama Legal: INFORME_INTEGRIDAD_SHA256.md & Hashes"]
    D --> E3["🗣️ Rama Ciudadana: LINEA_DE_TIEMPO_INCIDENTES_Y_ATAQUES.md"]

    A --> F["Fase 3: Cicatrices XREF & Cobertura CIDH (06 Julio - 07 Agosto)"]
    F --> G1["🔬 Rama Técnica: REPORTE_MASIVO_DEEPFAKES.md (57.9k PDFs XREF)"]
    F --> G2["⚖️ Rama Legal: ACTA_DE_HALLAZGOS_FORENSES_MATRIZ_14_PUNTOS.md"]
    F --> G3["🗣️ Rama Ciudadana: siguiendo_la_anomalia.md"]

    A --> H["Fase 4: Consolidación Acervo >677 GB & Suite Local (22 - 31 Agosto)"]
    H --> I1["🔬 Rama Técnica: INFORME_CONSOLIDADO_ACERVO_677GB.md & Modelfile"]
    H --> I2["⚖️ Rama Legal: MEMORIA_PERMANENTE_NARRATIVA_CHRONICLE.md"]
    H --> I3["🗣️ Rama Ciudadana: PWA App & Simulador Ciber-Táctico"]
```
