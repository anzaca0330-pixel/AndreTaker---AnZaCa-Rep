...
| **Comportamiento Estadístico** | Detección del desplome de participación (-53%) de la Mesa 013 a la 014 ($t(17) = 8.2, p < 0.00001$). | **Desviación Nacional Ley de Benford (2BL):** Varianza nula inter-mesa y distorsión del segundo dígito en 233.448 mesas ($\chi^2 = 1.755,91, p < 0.001$). | De una anomalía local ($N=19$ mesas) en Los Ángeles se pasó a la demostración cuantitativa masiva ($N=233.448$). |
