...
**Justificación del Análisis del Segundo Dígito (Prueba 2BL):** La Ley del segundo dígito de Mebane estándar (Primer Dígito) es matemáticamente inválida para datos electorales a nivel de mesa porque estas tienen topes poblacionales artificiales (ej. máximo 350-400 votantes). Esto restringe artificialmente el primer dígito. Para resolver esto, aplicamos la prueba de la Ley del segundo dígito de Mebane del Segundo Dígito (2BL), pionera por el politólogo Walter Mebane. El segundo dígito es estadísticamente inmune a los topes poblacionales, permitiéndonos medir con precisión la evasión algorítmica PRNG frente al sesgo humano.
...
2.  **Distribución del Segundo Dígito al 20.18%:** Varianza algorítmica perfecta diseñada para evadir la detección de la Ley del segundo dígito de Mebane.
...
| **Ley del segundo dígito de Mebane (2BL)** | Ley matemática que dicta que en conjuntos de datos naturales, el segundo dígito sigue una distribución logarítmica específica. Su violación indica generación sintética de números. |
